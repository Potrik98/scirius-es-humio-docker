...
ELASTICSEARCH_ADDRESS = "es-elasticsearch:9200"
...
#ELASTICSEARCH_HOSTNAME = "hostname"
...
ES_BACKEND = 'ELASTICSEARCH'
#ES_BACKEND = 'HUMIO'
SCIRIUS_VERSION = SCIRIUS_VERSION + ' - backend: ' + ES_BACKEND
#HUMIO_API_TOKEN = '0djAnnwsaqBvc8hOIDK7asJjdlah0sq5beKrRKQ1pTUX'
#HUMIO_HOST = 'https://humio-stud.cert-labs.uninett.no'
##HUMIO_HOST = 'https://vg.no'
#HUMIO_REPOSITORY = 'suricata'
#HUMIO_TIMELINE_CHUNK_SIZE = 2

USE_ELASTICSEARCH = True
#ELASTICSEARCH_ADDRESS = "l:9200"
